...
export const info = {
  ...
  portfolio: [
    // This is where your portfolio projects will be detailed
    {
      ...
      image: moodmusica,
      techstack: [
        "React.js, Python Flask, Google Firebase, Spotify API, Face API",
      ],
    },
    {
      title: "Generative AI Apps In Python",
      source:
        "https://github.com/slidracoon72/Generative-AI-Powered-Applications-with-Python",
      image: gen_ai,
  ...
  research: [
    ...
    },
    {
      ...
      source:
        "https://www.researchgate.net/publication/361519983_K-mean_and_mean-shift_algorithms_in_machine_learning_model_for_efficient_malware_categorisation",
    },
  ],
};
