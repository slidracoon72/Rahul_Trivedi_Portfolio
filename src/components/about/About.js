      ...
      <>
        ...
        <ul>
          {info.education.map((school, index) => (
            <li key={index}>
              <span style={{ color: info.baseColor }}>{school.area}</span> @{" "}
              {school.institution} GPA: {school.gpa} [{school.start} -{" "}
              {school.end}]
            </li>
          ))}
        </ul>
  ...
  function certificates() {
    return (
      <>
        ...
        <p>
          <span style={{ color: info.baseColor }}>
            certifications <span className={Style.green}>(main)</span> $
          </span>{" "}
          ls
        </p>
        <ul>
          {info.certificates.map((certificate, index) => (
            <li key={index}>
              <span style={{ color: info.baseColor }}>{certificate.title}</span>{" "}
              by {certificate.by}{" "}
              <a href={certificate.source} rel="noreferrer" target="_blank">
                View
              </a>
            </li>
          ))}
  ...
  function skillsText() {
    return (
      <>
        ...
        <p style={{ color: info.baseColor }}> AI & ML</p>
        <ul className={Style.skills}>
          {info.skills.aiAndMl.map((skill, index) => (
            <li key={index}>{skill}</li>
          ))}
        </ul>
        <p style={{ color: info.baseColor }}> AI & Automation Tools</p>
        <ul className={Style.skills}>
          {info.skills.aiAndAutomationTools.map((tool, index) => (
    ...
    return (
      <>
        ...
        <p>
          <span style={{ color: info.baseColor }}>
            {" "}
            research/publications <span className={Style.green}>(main)</span> $
          </span>{" "}
          ls
        </p>
        <ul>
            ...
            <li key={index}>
              <p>
                ...
                <span className={Style.green}>
                  {" "}
                  <a href={research.source} rel="noreferrer" target="_blank">
                    {research.journal}
                  </a>
                </span>
              </p>
